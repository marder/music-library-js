            ...
            if (line[0] == '#') {
                ...
                if (line.length > 1) {
                    ...
                    switch (line[1].toLowerCase()) {
                        case "version":
                            let fileVersion = line[2];
                            if (versionCompare(fileVersion, MusicFolder.MinRequiredVersion) < 0) {
                                // File version is not supported.
                                console.error(`Can't parse ${cacheFile}. It's version is too old.`)
                                return;
                            }
                            break;
                    }
